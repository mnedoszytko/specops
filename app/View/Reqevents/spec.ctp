...
<div class="reqevents index">
	<h2>Program specjalizacji <?=$spec['Spec']['name']?></h2>
	...
	<tr>
		...
		<td><?=$event_types[$reqevent['Reqevent']['type']];?>&nbsp;</td>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New Reqevent'), array('action' => 'add','spec_id'=>$spec['Spec']['id'])); ?></li>
